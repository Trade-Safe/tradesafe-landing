...
export default function Header() {
  ...
  return (
    <header className="bg-[rgba(15,15,15,0.95)] backdrop-blur-[10px] border-b border-[#1a1a1a] sticky top-0 z-[1000]">
      <nav className="max-w-[1200px] mx-auto px-6 md:px-12 py-3 flex justify-between items-center">
        {/* Logo */}
        ...
        {/* Mobile Menu Panel */}
        <div className={`
          fixed top-0 right-0 h-full w-[280px] bg-[#0f0f0f] border-l border-[#1a1a1a] z-[1000]
